...
const App = () => {
    ...
    return (
        <ParaWrapper id = "About_ParaWrapper">
            ...
            <Paragraph className = "About_paragraph">
                I believe that one must constantly strive to live outside their comfort zone and improve on his craft. A person can only grow and become the best version of himself by living in the edge. 
            </Paragraph>
            <Paragraph className ="About_paragraph">
                The journey to realize one's true potential is like climbing a muddy hill. If he stays still, he slides back and loses the progress he has made. That is why he must constantly put in the work to climb to the peak. This is why I am on the path of constant improvement.
                </Paragraph>
