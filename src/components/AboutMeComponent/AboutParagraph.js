...
const App = () => {
    ...
    return (
        <ParaWrapper id = "About_ParaWrapper">
            ...
            <Paragraph className ="About_paragraph">
                The journey to realize his true potential is like climbing a muddy hill. If he stays still, he slides back and loses the progress he has made. That is why he must constantly put in the work to climb to the peak. This is why I am on the path of constant improvement.
                </Paragraph>
